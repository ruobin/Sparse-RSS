...
public final class MyStrings {
	...
	public static final String PACKAGE = "cn.eric.rss";
	...
	public static final String ACTION_REFRESHFEEDS = "cn.eric.rss.REFRESH";

	public static final String ACTION_UPDATEWIDGET = "cn.eric.rss.FEEDUPDATED";

	public static final String ACTION_RESTART = "cn.eric.rss.RESTART";
	...
	public static final String DB_EXCUDEFAVORITE = new StringBuilder(
			FeedData.EntryColumns.FAVORITE).append(MyStrings.DB_ISNULL)
			.append(" OR ").append(FeedData.EntryColumns.FAVORITE).append("=0")
			.toString();
